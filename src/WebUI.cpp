...
void WebUI::handleRoot() {
    String html =
        F("<!DOCTYPE html><html><head><title>PlaneTracker Setup</title>"
          ...
          "#scrWrap:fullscreen{background:#000;display:flex;align-items:center;justify-content:center}"
          "#scrWrap:fullscreen #scr{width:min(90vh,90vw)!important;height:min(90vh,90vw)!important;"
          "font-size:calc(min(90vh,90vw)*12/256)!important}"
          "</style>"
          ...
          "function toggleFullscreen(){"
            "var el=document.getElementById('scrWrap');"
