...
void WebUI::handleRoot() {
    String html =
        F("<!DOCTYPE html><html><head><title>PlaneTracker Setup</title>"
          ...
          "#liveMap.map-expanded{position:fixed;top:0;left:0;"
          "width:100vw!important;height:100vh!important;z-index:998;border-radius:0!important}"
          ...
          "function toggleFullscreen(){"
            ...
            "if(mapOn){"
              "var m=document.getElementById('liveMap');"
              "var expanded=m.classList.toggle('map-expanded');"
              "var btn=document.getElementById('fsBtn');"
              "if(btn)btn.innerHTML=expanded?'<i class=\"fa-solid fa-compress\"></i>':'<i class=\"fa-solid fa-expand\"></i>';"
              "if(_lmap)setTimeout(function(){_lmap.invalidateSize();},100);"
            "}else{"
